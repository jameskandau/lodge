...
class PaymentController extends Controller
{
    ...
    public function create($id)
    {
        ...
        $amount = Booking::findOrFail($id);

        $totals = $amount->room->types->price * $amount->days;

        return view('payments.create', compact('customers','pay_id','bookings','totals'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $pay->totals = $request->input('total');
        $fullcharges = $request->input('total') + $request->input('amount');
        $pay->fullcharges  = $fullcharges;
